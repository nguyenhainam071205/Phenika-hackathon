...
from rag1.kb_schema import Detection, ImageSize, PatientContext, RAG1Request
...
def _to_rag1_request(
    ...
    return RAG1Request(
        query_id=query_id,
        study_id=dicom_block.get("study_instance_uid") or "",
        image_id=dicom_block.get("sop_instance_uid") or "",
