"""
Minimal FastAPI wrapper for the RAG1 handoff package.

This lets frontend developers call RAG1 through HTTP instead of shelling out
to the CLI directly.
"""
...
app = FastAPI(
    title="RAG1 Dev Handoff API",
    version="1.0.0",
    description="HTTP wrapper for the DICOM -> YOLO -> RAG1 pipeline.",
)
app.add_middleware(
    CORSMiddleware,
...
def _find_sample_dicom(sample_id: str) -> Path:
    ...
    # Allow caller to pass the full wrapper directory name.
