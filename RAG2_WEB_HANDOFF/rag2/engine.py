    ...
    def process(
        ...
        *,
        ...
        if not skip_validation:
            ...
            retryable_rules = {"FINDINGS_COVERAGE", "ICD10_FALSE_ADD", "CRITICAL_MISS", "URGENCY_MISMATCH"}
            ...
            if validation.errors:
                ...
                # Flag to UI and board that system failed and blocked the output implicitly
                response.metadata.report_status = "FAILED_VALIDATION"
                print(f"  [WARN] Validation found {len(validation.errors)} errors. "
                      f"Report status flagged as FAILED_VALIDATION.")
